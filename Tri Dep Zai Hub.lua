...
local Tabs = {
    Main = Window:AddTab({ Title = "Tap Main", Icon = "home" }),
    Setting = Window:AddTab({ Title = "Tap Setting", Icon = "settings" }),
    Stats = Window:AddTab({ Title = "Tap Stats", Icon = "plus-circle" }),
    Player = Window:AddTab({ Title = "Tap Player", Icon = "box" }),
    Teleport = Window:AddTab({ Title = "Teleporting island", Icon = "palmtree" }),
    Fruit = Window:AddTab({ Title = "Tap Fruit", Icon = "cherry" }),
    Raid = Window:AddTab({ Title = "Tap Raid", Icon = "swords" }),
    Race = Window:AddTab({ Title = "Tap Race V4", Icon = "chevrons-right" }),
    Shop = Window:AddTab({ Title = "Tap Shop", Icon = "shopping-cart" }),
	Misc = Window:AddTab({ Title = "Tap Misc", Icon = "list-plus" }),
    Hop = Window:AddTab({ Title = "Tap Hop", Icon = "wifi" }),
}
